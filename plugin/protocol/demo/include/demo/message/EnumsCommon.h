...
///    @ref demo::message::Enums message and its fields.
...
/// @see demo::message::EnumsFields
struct EnumsFieldsCommon
{
    /// @brief Common types and functions for
    ///     @ref demo::message::EnumsFields::F1 field.
    struct F1Common
    {
        ...
        /// @brief Name of the @ref demo::message::EnumsFields::F1 field.
    ...
    /// @brief Common types and functions for
    ///     @ref demo::message::EnumsFields::F2 field.
    struct F2Common
    {
        /// @brief Values enumerator for
        ///     @ref demo::message::EnumsFields::F2 field.
        ...
        /// @brief Name of the @ref demo::message::EnumsFields::F2 field.
        static const char* name()
        {
            return "F2";
        }
    ...
    /// @brief Common types and functions for
    ///     @ref demo::message::EnumsFields::F3 field.
    struct F3Common
    {
        /// @brief Values enumerator for
        ///     @ref demo::message::EnumsFields::F3 field.
        ...
        /// @brief Name of the @ref demo::message::EnumsFields::F3 field.
        static const char* name()
        {
            return "F3";
        }
    ...
    /// @brief Common types and functions for
    ///     @ref demo::message::EnumsFields::F4 field.
    struct F4Common
    {
        /// @brief Values enumerator for
        ///     @ref demo::message::EnumsFields::F4 field.
        ...
        /// @brief Name of the @ref demo::message::EnumsFields::F4 field.
        static const char* name()
        {
            return "F4";
        }
...
///     @ref demo::message::Enums message.
/// @see demo::message::Enums
struct EnumsCommon
{
    /// @brief Name of the @ref demo::message::Enums message.
    static const char* name()
    {
        return "Enums";
    }
