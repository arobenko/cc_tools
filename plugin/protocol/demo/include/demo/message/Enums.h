...
#include "demo/message/EnumsCommon.h"
...
/// @see @ref Enums
/// @headerfile "demo/message/Enums.h"
...
struct EnumsFields
{
    ...
    /// @see @ref demo::message::EnumsFieldsCommon::F1Val
    class F1 : public
        comms::field::EnumValue<
            demo::field::FieldBase<>,
            demo::message::EnumsFieldsCommon::F1Val,
    ...
    public:
        ...
        {
            return demo::message::EnumsFieldsCommon::F1Common::name();
        }
        
        /// @brief Retrieve name of the enum value
        static const char* valueName(ValueType val)
        {
            return demo::message::EnumsFieldsCommon::F1Common::valueName(val);
        }
    ...
    /// @see @ref demo::message::EnumsFieldsCommon::F2Val
    class F2 : public
        comms::field::EnumValue<
            demo::field::FieldBase<>,
            demo::message::EnumsFieldsCommon::F2Val,
    ...
    public:
        ...
        static const char* name()
        {
            return demo::message::EnumsFieldsCommon::F2Common::name();
        }
        
        /// @brief Retrieve name of the enum value
        static const char* valueName(ValueType val)
        {
            return demo::message::EnumsFieldsCommon::F2Common::valueName(val);
        }
    ...
    /// @see @ref demo::message::EnumsFieldsCommon::F3Val
    class F3 : public
        comms::field::EnumValue<
            demo::field::FieldBase<>,
            demo::message::EnumsFieldsCommon::F3Val,
    ...
    public:
        ...
        static const char* name()
        {
            return demo::message::EnumsFieldsCommon::F3Common::name();
        }
        
        /// @brief Retrieve name of the enum value
        static const char* valueName(ValueType val)
        {
            return demo::message::EnumsFieldsCommon::F3Common::valueName(val);
        }
    ...
    /// @see @ref demo::message::EnumsFieldsCommon::F4Val
    class F4 : public
        comms::field::EnumValue<
            demo::field::FieldBase<>,
            demo::message::EnumsFieldsCommon::F4Val,
    ...
    public:
        ...
        static const char* name()
        {
            return demo::message::EnumsFieldsCommon::F4Common::name();
        }
        
        /// @brief Retrieve name of the enum value
        static const char* valueName(ValueType val)
        {
            return demo::message::EnumsFieldsCommon::F4Common::valueName(val);
        }
...
class Enums : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<demo::MsgId_Enums>,
...
public:
    ...
    {
        return demo::message::EnumsCommon::name();
    }
