...
#include "demo/input/ServerInputMessages.h"
...
///     using MyScaledInts = demo::message::ScaledInts<MyInterface, demo::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in demo/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<demo::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<demo::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo::options::DefaultOptions.
/// @headerfile "demo/dispatch/DispatchServerInputMessage.h"
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(demo::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(demo::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<demo::options::DefaultOptions>;
