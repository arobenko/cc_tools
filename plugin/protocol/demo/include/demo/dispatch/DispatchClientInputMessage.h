...
#include "demo/input/ClientInputMessages.h"
...
///     using MySomeOtherMessage = demo::message::SomeOtherMessage<MyInterface, demo::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in demo/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<demo::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<demo::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo::options::DefaultOptions.
/// @headerfile "demo/dispatch/DispatchClientInputMessage.h"
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(demo::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(demo::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<demo::options::DefaultOptions>;
