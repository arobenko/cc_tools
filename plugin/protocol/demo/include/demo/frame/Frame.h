...
#include "demo/field/MsgId.h"
#include "demo/frame/FrameCommon.h"
...
struct FrameLayers
{
    ...
    struct SizeMembers
    {
            ...
            >
        {
            ...
            {
                return demo::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::name();
            }
    ...
    struct ChecksumMembers
    {
            ...
            >
        {
            ...
            static const char* name()
            {
                return demo::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::name();
            }
    ...
    struct SyncMembers
    {
            ...
            >
        {
            ...
            static const char* name()
            {
                return demo::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::name();
            }
...
template <
   typename TMessage,
   typename TAllMessages = demo::input::AllMessages<TMessage>,
   typename TOpt = demo::options::DefaultOptions
>
class Frame : public
